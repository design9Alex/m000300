...
class ContactAMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $subject = str_replace($searches, $replaces, $this->notify->custom_subject);
        $preheader = str_replace($searches, $replaces, $this->notify->custom_preheader);
        $editor = str_replace($searches, $replaces, $this->notify->custom_editor);
